...
namespace UnitTests
{
    ...
    public class TestRSAPadding
    {
        ...
        public void TesRSAPadding()
        {
            ...
            var rsa = RSA.FromPrivateKey(bio, s);
            ...
            Assert.AreEqual("58cd62d40406cea83240447720c8d60a194f8293ce81f39c983a285d2497eef9".ToUpper(), digBytes.ToUpper());
            Assert.AreEqual("", result64);
        }
    }
}
